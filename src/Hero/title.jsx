...
export default function title() {
  return (
    <div className='justify-center flex items-center flex-col gap-5 mt-20 max-w-full'>
      ...
      <img src={SearchIcon} className='absolute  w-4  ml-4' alt="" /><input type="text" placeholder='Search for a place' className='w-[350px] h-10 px-10 text-sm border-none rounded-md outline-none bg-secondary'/>
      </div>
