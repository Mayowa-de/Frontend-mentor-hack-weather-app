        ...
        <div className='min-h-screen  w-full  z-50 justify-center flex items-center relative'>
           ...
           {/* Error handling of the loading state */}
            ...
            <div className='flex w-full p-2  bottom-10  absolute'>
                ...
                <button onClick={handleAskAdvice} disabled={loading} className='flex p-4 px-5 md:px-10 rounded-r-full bg-secondary text-center justify-center text-white '>{loading ? "Thinking..." : "Ask"}
            </button>
            </div>
