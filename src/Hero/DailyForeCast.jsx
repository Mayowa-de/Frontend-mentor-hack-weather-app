  ...
  return (
    <div className='flex flex-col mt-10 text-white gap-4'>
      ...
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
        ...
        <div className='flex gap-5 w-full'>
            <div className='flex '>
            <p>21</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
            <div className='flex  justify-end w-full'>
            <p>15</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
        </div>
        </div>
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
        ...
        <div className='flex gap-5 w-full'>
            <div className='flex '>
            <p>24</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
            <div className='flex  justify-end w-full'>
            <p>14</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
      ...
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
        ...
        <div className='flex gap-5 w-full'>
            <div className='flex '>
            <p>25</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
            <div className='flex  justify-end w-full'>
            <p>13</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
        </div>
        </div>
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
      ...
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
        ...
        <div className='flex gap-5 w-full'>
            ...
            <div className='flex  justify-end w-full'>
            <p>16</p><span className='-mt-1 text-[12px]'>o</span>
            </div>
        </div>
        </div>
      <div className='card flex flex-col gap-5 bg-card w-28 items-center justify-center  rounded-xl p-2 shadow-xl'>
