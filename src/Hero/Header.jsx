  ...
  return (
    <div className="w-full flex z-50  mt-5">
      <div className="w-full justify-between flex   mt-2">
        ...
        <div className="flex flex-col w-full justify-end items-end z-10 dropdown">
          <button className="btn items-center p-5  border-none shadow-none focus:outline-white focus:outline-2 flex bg-secondary text-white px-2 h-7 rounded-md ">
            <div className="flex justify-center  gap-2">
              <img src={UnitIcon} className="w-4" aria-label="setting image" alt="setting icon" />
              <p value={unit} className="text-15 font-light">
                Units
              </p>
              <img src={dropdown} onClick={toggleDown} aria-label="dropdown image" alt='dropdown image' className="text-3"/>
            </div>
          </button>
          {open && (
            <div
            ...
            >
              <div className="flex z-20 flex-col gap-3 p-2 text-white/90">
                <div
                  ...
                  className="bg-card cursor-pointer w-full h-12 rounded-xl flex items-center"
                >
                  ...
                  <>
                        ...
                        >
                          <p className="text-sm flex">
                            ...
                            {selected.temperature === temp && (
                              <img
                                src={CheckIcon}
                                className="w-4 h-4 absolute ml-44"
                                aria-label="checked image"
                                alt="checked icon"
                              />
                            )}
                          </p>
                    ...
                    {["Km/h", "mph"].map((wind) => {
                      ...
                      return (
                        <div
                          key={wind}
                          onClick={() => handleSelect("wind", wind)}
                          className={` w-full pl-2  rounded-xl ${
                            isSelected ? "h-12 bg-card" : "bg-transparent"
                    ...
                    {/* Precipitation unit selection section */}
                    ...
                    {["Millimeters (mm)", "Inches"].map((ppt) => {
                      ...
                      return (
                        ...
                        >
                          <p className="text-sm flex ">
                            {ppt}{" "}
                            {selected.precipitation === ppt && (
                              <img
                                src={CheckIcon}
                                className="w-4 h-4 absolute ml-44 flex"
                                aria-label="checked image"
                                alt="checked icon"
                              />
                            )}
