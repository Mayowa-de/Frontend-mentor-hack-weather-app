...
const getWeatherIcon = (code) =>{
  ...
  if([2,3].includes(code)) return  '../assets/images/icon-partly-cloudy.webp'
  if([45,48].includes(code)) return  '../assets/images/icon-fog.webp'
  if([51,61,63,65].includes(code)) return  '../assets/images/icon-drizzle.webp'
  ...
  if([63].includes(code)) return '../assets/images/icon-rain.webp'
}
export default function todayCloud() {
  ...
  useEffect(() =>{
   ...
   const iconFile= getWeatherIcon[weather.weathercode] || 'default.webp';
